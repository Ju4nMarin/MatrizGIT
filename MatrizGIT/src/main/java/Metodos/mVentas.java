...
public class mVentas {
    ...
    mVentas() {
        nv = Integer.parseInt(JOptionPane.showInputDialog(null,
                "Entre el número de vendedores: ", "NUMERO DE VENDEDORES", PLAIN_MESSAGE));
        nm = Integer.parseInt(JOptionPane.showInputDialog(null,
                "Entre el número de meses: ", "NUMERO DE MESES", PLAIN_MESSAGE));
            ...
            for (j = 0; j < nm; j++) {
                ventas[i][j] = Double.parseDouble(
                        JOptionPane.showInputDialog(null,
                                ...
                                + " en el mes " + j + ":", "INGRESAR VALORES PARA LA MATRIZ", PLAIN_MESSAGE));
            }
        }
    }
